...
namespace coen79_lab9
{
    ...
    // Library facilities used: cstdlib
    {
        ...
        if (node_ptr != NULL)
        {
            postorder(f, node_ptr->left_field);
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
            f(node_ptr);
            preorder(f, node_ptr->left_field);
            preorder(f, node_ptr->right_field);
    ...
    // Library facilities used: cstdlib
    {
        ...
        if (root_ptr != NULL)
        {
            ...
            tree_clear(child);  //clear right child
            delete root_ptr;    //after clearing both children, delete root
            root_ptr=NULL;
        }
    ...
    // Library facilities used: cstdlib
    {
        ...
        else
        {
            ...
            binary_tree_node<Item> *newRoot = new binary_tree_node<Item>(root_ptr->data(), l_ptr, r_ptr);    //root of copied tree
