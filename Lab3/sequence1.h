...
namespace coen79_lab3 {
    ...
    public:
        ...
        //Precondtion: is_item() returns true
        ...
        sequence operator+=(const class sequence& rhs);
    ...
    sequence operator+(const class sequence& lhs, const class sequence& rhs);
    //Postcondition: The sequence that is returned contains all the
    //     numbers of the sequences of lsh and rhs.

    sequence::value_type summation(const class sequence &s);
