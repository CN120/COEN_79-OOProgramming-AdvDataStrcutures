...
namespace coen79_lab2{
    ...
    public:
        statistician();
        void next(double r); //initialize object
        void reset(); //clears statistician
        
        int length() const; //retuns count of number sequence
        double sum() const; //sum of all numbers
        double mean() const; //average
        double minimum() const;
        double maximum() const;
        
        //overloaded operators
        //"friend" gives access to private member functions
